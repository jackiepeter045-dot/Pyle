...
/* Research note:
   Amazon puts search front-and-centre on mobile — the search bar IS the homepage.
   Etsy uses horizontal scrollable category pills as "suggestions," not a grid of large icons.
   TikTok Shop hides the seller path entirely on the homepage — discovery first.
   PYLE follows the same logic: buyer-first, search prominent, categories as pills,
   "Become a seller" stays in the account area only. */
  ...
  return (
    <div>
      ...
      <section className="bg-forest text-white px-5 pt-10 pb-12">
        ...
        {/* Category suggestion pills — like Etsy/Amazon search suggestions */}
